module Fastlane
  module Actions
    ...
    class SignApkAction < Action
      ...
      sign_cmd << ["#{params[:apk_path_signed].shellescape}"] if params[:apk_path]
      ...
      if params[:apk_path_signed]
        sign_cmd << ["-signedjar #{params[:apk_path_signed]}" ]
        Actions.lane_context[SharedValues::SIGNED_APK_PATH] = "#{params[:apk_path_signed]}"
      ...
      def self.available_options 
        ...
        [
          FastlaneCore::ConfigItem.new(key: :apk_path,
                                       ...
                                       optional: true),
          FastlaneCore::ConfigItem.new(key: :apk_path_signed,
